...
os.chdir(os.path.normpath(os.path.join(root_dir, project_dir, "lang")))
...
for lang in downloadedLanguages:
    ...
    try:
        credits = getTranslatorsFromCredits(
            data["{0} {0} {0} Contributors, please add your names/usernames separated by comas (for credit purposes)"])
    except KeyError as e:
        print(e)
...
translations_filepath = os.path.normpath(
    os.path.join(root_dir, project_dir, "data/translations.py"))
